...
11. **Animaciones de Exclusión Espacial**: En escenas con múltiples objetos flotantes animados dinámicamente con transformaciones infinitas (Vortex/Space), se debe definir **Anillos Orbitales de Exclusión** (canales de X/Y no intersectados) para garantizar que los elementos nunca se solapen visualmente mientras comparten el mismo centro de rotación o escenario.
